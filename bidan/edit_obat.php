...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_query = "UPDATE obat SET nama_obat = '$nama_obat', jenis_obat = '$jenis_obat', jumlah = $jumlah, harga_obat = $harga_obat, subtotal_obat = $subtotal_obat WHERE ID_obat = $id";
        ...
        <form action="" method="POST">
            ...
            <div class="mb-3">
                ...
                <select name="jenis_obat" id="jenis_obat" class="form-control" required>
                    ...
                    <option value="Sirup" <?= $data['jenis_obat'] == 'Sirup' ? 'selected' : '' ?>>Sirup</option>
                </select>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="harga_obat" id="harga_obat" class="form-control" value="<?= htmlspecialchars($data['harga_obat']) ?>" required>
            </div>
            <div class="d-grid">
